...
import type { CampaignReport, Employee, EmployeeSummary, EventType, GeneratedCampaign, Simulation } from "./types";
import "./styles.css";
...
function App() {
  ...
  const enrich = () => selected && run("enrich", async () => {
    ...
    setNotice("Profile 已更新；所有公開事實均附來源與資料狀態。");
  });
