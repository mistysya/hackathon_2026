...
Copy `.env.example` to `.env` and set an OpenAI API Platform Project key and an
enabled Responses model. The following test sends one fake-data-only, chargeable
